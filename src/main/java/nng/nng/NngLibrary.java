...
public class NngLibrary {
	 ...
	 */
	@Name("nng_aio_alloc") 
	public static int nngAioAlloc(Pointer<Pointer<nng_aio > > nng_aioPtrPtr1, Pointer<NngLibrary.NngAioAllocArg1Callback > arg1, Pointer<? > voidPtr1) {
	...
	public static void nngAioSetMsg(Pointer<nng_aio > nng_aioPtr1, Pointer<NngLibrary.nng_msg > nng_msgPtr1) {
	...
	public static Pointer<NngLibrary.nng_msg > nngAioGetMsg(Pointer<nng_aio > nng_aioPtr1) {
