...
/**
 * <i>native declaration : nng.h:9</i><br>
 ...
 */
@Library("core") 
public class nng_listener_s extends StructObject {
	static {
		BridJ.register();
	}
	@Field(0) 
	...
	@Field(0) 
	public nng_listener_s id(int id) {
		this.io.setIntField(this, 0, id);
		return this;
	}
	public nng_listener_s() {
		super();
	}
	public nng_listener_s(Pointer pointer) {
		super(pointer);
	}
}
